...
░░░░░░░░╚════╝░╚═╝░░╚═╝╚══════╝░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝""")
time.sleep(2)
print("Creator  -  Catchii ")
time.sleep(0.3)
print("https://github.com/Catchii/NitroGenerator   \n")
time.sleep(0.2)
...
with open("Nitro Codes.txt") as f:
    for line in f:
        ...
        if r.status_code == 200:
            print(" Valid POGGGGGGGGGGGGg | {} ".format(line.strip("\n")))
            break
        else:
        	print(" Invalid L | {} ".format(line.strip("\n")))
input("The end! Press Enter 5 times to close the program.")
input("4")
input("3")
input("2")
input("1")
input("Dont Forget To Star The Repo")